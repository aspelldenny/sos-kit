# Changelog archive — pre-v2.2 (v2.1.x → v1)

> Archived 2026-06-09 from `CHANGELOG.md` to keep the live changelog under the 40k doc-size threshold.
> Live changelog (v2.2 wave onward) stays in `CHANGELOG.md`. This file is the frozen tail: v2.1.10 down to v1.
> Companion archive: `docs/archive/DISCOVERIES_pre-2026-05.md`.
