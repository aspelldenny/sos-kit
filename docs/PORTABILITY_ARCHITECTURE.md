...
| P078 | Codex native adapter | Fresh install sinh đúng Codex-native files và doctor xác nhận; không copy doctrine fork — **IN PROGRESS**: P078b1 foundation DONE (crate+detect/verify+wire), P078b2 (declarative render) + P078b3 (enforcement+guard-rewrite) còn lại |
